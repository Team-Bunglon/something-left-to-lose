...
var dialogues = [
	...
	"[Raka 2]\nYes, but still, you can feel it physically\nSo, to get out before things get any more dangerous, we need to go west.",
	"[Raka 3]\nI figured the creepy hallucinations thing is going to chase us again?",
	"[Raka 2]\nYep.",
	"[Raka 3]\nMan…"
]
...
var positive_dialogues = [
	"[Raka 3]\nAbsolutely!\nCant wait to inhale some puddings in our fridge once we got home!",
